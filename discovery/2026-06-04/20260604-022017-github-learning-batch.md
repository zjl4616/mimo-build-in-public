# GitHub Learning Batch 20260604-022017

- corpus: `/home/ubuntu/mimo-token-to-cash/discovery/github-learning-corpus.jsonl`
- total learned metadata: 12263
- new this run: 3

## 最新项目样本（用于提炼需求/服务/触达）

1. **priyankaparadkarr/priyanka-ai-security-portfolio** ★0 ``
   - 
   - https://github.com/priyankaparadkarr/priyanka-ai-security-portfolio
   - query: ai security
2. **danielof26/RAG-chatbot-web** ★0 `JavaScript`
   - 
   - https://github.com/danielof26/RAG-chatbot-web
   - query: rag chatbot
3. **Asphane/YT-ChatBot-RAG** ★0 `Jupyter Notebook`
   ...
   - query: rag chatbot
4. **gmh5225/awesome-ai-security** ★21 ``
   ...
   - query: ai security
5. **madhucnghubphilips/AI-Security-Learning-Hub** ★0 ``
   ...
   - query: ai security
6. **emaina-SecEngr/AbuTech-ai-security-platform** ★0 `Python`
   ...
   - query: ai security
7. **YSR4038/Apex-Retail-Intelligence-Secure-Operations-AI-Security-Console** ★0 `TypeScript`
   ...
   - query: ai security
8. **Daryoush1989/ai-security-triage-platform** ★0 `Python`
   - 
   - https://github.com/Daryoush1989/ai-security-triage-platform
   - query: ai security
9. **zosob/AgentGuardian** ★0 `Python`
...
14. **Av1352/rag-chatbot-faiss** ★0 `Python`
   - 
   - https://github.com/Av1352/rag-chatbot-faiss
   - query: rag chatbot
15. **adya07pandey/CreatorLens** ★0 `Python`
   ...
   - query: rag chatbot
16. **Kanaieu/chatKUHP** ★0 `TypeScript`
   ...
   - query: rag chatbot
17. **I-am-Hanish/RAG-CHATBOT** ★0 `Python`
   - 
   - https://github.com/I-am-Hanish/RAG-CHATBOT
   - query: rag chatbot
18. **Meirah0/rag-ai-chatbot** ★0 ``
...
35. **erchandrain-ui/Email-Automation-Reminder-System** ★0 `HTML`
   ...
   - query: email automation
36. **Elavarasan-Saravanan/Open-Invoice-Automation** ★0 ``
   ...
   - query: invoice automation
37. **annai-stack/oangle-lead-finder** ★0 `Python`
...
39. **MadhuSudhan138/Email_NonStop** ★0 ``
   ...
   - query: email automation
40. **Vinphy6/outlook-email-automation** ★0 ``
   - 
   - https://github.com/Vinphy6/outlook-email-automation
   - query: email automation
41. **mansisonani07/immigration-lead-gen-system** ★0 ``
...
50. **ibmbpm/ibm-baw-mcp-server** ★9 `Python`
   ...
   - query: business automation
51. **Krishna17-bit/ContentFlow** ★0 ``
   ...
   - query: content automation
52. **yossweh/cold-email-engine** ★0 ``
   ...
   - query: email automation
53. **saeseduardo/ai-customer-service-platform** ★0 ``
...
54. **nirbhayalone27/Skynex** ★1 `JavaScript`
...
55. **sekharson/LaunchBoost** ★0 ``
   ...
   - query: lead generation
56. **sekharson/Launch-Boost** ★0 ``
   - LaunchBoost is a modern digital marketing services website for startups featuring responsive design, interactive service sliders, pricing plans, case studies, comparison tables, and lead-generation focused user experienc
   - https://github.com/sekharson/Launch-Boost
   - query: lead generation
57. **ambrose-kutti/ML-PaperStream** ★0 ``
   ...
   - query: zapier
58. **anujkd09/Zapier-deployment-events-api** ★0 ``
   ...
   - query: zapier
59. **exekyute/zapier-proj-health-rollup** ★0 ``
   ...
   - query: zapier
60. **hanschauhan464-art/AI-STUDENT-INTEREST-ANALYZER** ★0 ``
...
66. **tinkunagasaipavan/Content_Marketing** ★0 ``
   ...
   - query: lead generation
67. **kitretsu2809/YOUR_OWN_BUSINESS_CREW** ★0 ``
   - THE BUSINESS AUTOMATION 
   - https://github.com/kitretsu2809/YOUR_OWN_BUSINESS_CREW
   - query: business automation
68. **DDS-Solutions/AI-TadPole-OS** ★4 `TypeScript`
   ...
   - query: ai agent
69. **MemTensor/MemOS** ★9515 `TypeScript`
   - Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings
   - https://github.com/MemTensor/MemOS
   - query: ai agent
70. **everruns/sdk** ★0 `Python`
   ...
   - query: ai agent
71. **Austin-Muhe/UnknownMazeExplorer** ★0 `Python`
   ...
   - query: ai agent
72. **eranroseman/memoria-vault** ★1 `Python`
...
79. **tarunreddynerella/react-fitness-recommendation-agent** ★0 ``
   ...
   - query: email automation
80. **manikantamadicharla103-art/Email_Automation_system** ★0 ``
   - 
   - https://github.com/manikantamadicharla103-art/Email_Automation_system
   - query: email automation
81. **SoulTreaure/ai-customer-service** ★0 `Python`
   - AI?????????? - ??RAG??????????????
   - https://github.com/SoulTreaure/ai-customer-service
   - query: ai customer service
82. **AliAhmedSheikh/AI-B2B-Lead-Generation-System** ★0 ``
   - 
   - https://github.com/AliAhmedSheikh/AI-B2B-Lead-Generation-System
   - query: lead generation
83. **YVATSAL/LinkedIn-Lead-Generator** ★0 ``
   ...
   - query: lead generation
84. **Meenakshitm2005/FUTURE_UX_01** ★0 ``
   ...
   - query: lead generation
85. **Brendin10/ChicagoRealEstateLeadGeneration** ★0 ``
   - 
   - https://github.com/Brendin10/ChicagoRealEstateLeadGeneration
   - query: lead generation
86. **HBarefoot/engram** ★4 `JavaScript`
   ...
   - query: ai agent
87. **Qwkapital/blackstack-public** ★0 ``
   ...
   - query: ai agent
88. **gbessoni/seobuild-onpage** ★216 `Python`
   ...
   - query: ai agent
89. **Whatsonyourmind/deckforge** ★3 `Python`
   ...
   - query: ai agent
90. **joshimohanlalit1303-ctrl/ContextOS** ★0 `TypeScript`
   ...
   - query: ai agent
91. **JiangLin1297/Agent-Organization-Management** ★1 `HTML`
...
99. **ahakimsheik7/tayo360-frontdesk-ai** ★0 ``
   ...
   - query: business automation
100. **systempromptio/systemprompt-template** ★14 `Rust`
