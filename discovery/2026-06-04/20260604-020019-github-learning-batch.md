# GitHub Learning Batch 20260604-020019

- corpus: `/home/ubuntu/mimo-token-to-cash/discovery/github-learning-corpus.jsonl`
- total learned metadata: 12260
- new this run: 8

## 最新项目样本（用于提炼需求/服务/触达）

1. **gmh5225/awesome-ai-security** ★21 ``
   ...
   - query: ai security
2. **madhucnghubphilips/AI-Security-Learning-Hub** ★0 ``
   ...
   - query: ai security
3. **emaina-SecEngr/AbuTech-ai-security-platform** ★0 `Python`
   ...
   - query: ai security
4. **YSR4038/Apex-Retail-Intelligence-Secure-Operations-AI-Security-Console** ★0 `TypeScript`
   ...
   - query: ai security
5. **Daryoush1989/ai-security-triage-platform** ★0 `Python`
   - 
   - https://github.com/Daryoush1989/ai-security-triage-platform
   - query: ai security
6. **zosob/AgentGuardian** ★0 `Python`
...
11. **Av1352/rag-chatbot-faiss** ★0 `Python`
   - 
   - https://github.com/Av1352/rag-chatbot-faiss
   - query: rag chatbot
12. **adya07pandey/CreatorLens** ★0 `Python`
   ...
   - query: rag chatbot
13. **Kanaieu/chatKUHP** ★0 `TypeScript`
   ...
   - query: rag chatbot
14. **I-am-Hanish/RAG-CHATBOT** ★0 `Python`
   - 
   - https://github.com/I-am-Hanish/RAG-CHATBOT
   - query: rag chatbot
15. **Meirah0/rag-ai-chatbot** ★0 ``
...
32. **erchandrain-ui/Email-Automation-Reminder-System** ★0 `HTML`
   ...
   - query: email automation
33. **Elavarasan-Saravanan/Open-Invoice-Automation** ★0 ``
   ...
   - query: invoice automation
34. **annai-stack/oangle-lead-finder** ★0 `Python`
...
36. **MadhuSudhan138/Email_NonStop** ★0 ``
   ...
   - query: email automation
37. **Vinphy6/outlook-email-automation** ★0 ``
   - 
   - https://github.com/Vinphy6/outlook-email-automation
   - query: email automation
38. **mansisonani07/immigration-lead-gen-system** ★0 ``
...
47. **ibmbpm/ibm-baw-mcp-server** ★9 `Python`
   ...
   - query: business automation
48. **Krishna17-bit/ContentFlow** ★0 ``
   ...
   - query: content automation
49. **yossweh/cold-email-engine** ★0 ``
   ...
   - query: email automation
50. **saeseduardo/ai-customer-service-platform** ★0 ``
...
51. **nirbhayalone27/Skynex** ★1 `JavaScript`
...
52. **sekharson/LaunchBoost** ★0 ``
   ...
   - query: lead generation
53. **sekharson/Launch-Boost** ★0 ``
   - LaunchBoost is a modern digital marketing services website for startups featuring responsive design, interactive service sliders, pricing plans, case studies, comparison tables, and lead-generation focused user experienc
   - https://github.com/sekharson/Launch-Boost
   - query: lead generation
54. **ambrose-kutti/ML-PaperStream** ★0 ``
   ...
   - query: zapier
55. **anujkd09/Zapier-deployment-events-api** ★0 ``
   ...
   - query: zapier
56. **exekyute/zapier-proj-health-rollup** ★0 ``
   ...
   - query: zapier
57. **hanschauhan464-art/AI-STUDENT-INTEREST-ANALYZER** ★0 ``
...
63. **tinkunagasaipavan/Content_Marketing** ★0 ``
   ...
   - query: lead generation
64. **kitretsu2809/YOUR_OWN_BUSINESS_CREW** ★0 ``
   - THE BUSINESS AUTOMATION 
   - https://github.com/kitretsu2809/YOUR_OWN_BUSINESS_CREW
   - query: business automation
65. **DDS-Solutions/AI-TadPole-OS** ★4 `TypeScript`
   ...
   - query: ai agent
66. **MemTensor/MemOS** ★9515 `TypeScript`
   - Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings
   - https://github.com/MemTensor/MemOS
   - query: ai agent
67. **everruns/sdk** ★0 `Python`
   ...
   - query: ai agent
68. **Austin-Muhe/UnknownMazeExplorer** ★0 `Python`
   ...
   - query: ai agent
69. **eranroseman/memoria-vault** ★1 `Python`
...
76. **tarunreddynerella/react-fitness-recommendation-agent** ★0 ``
   ...
   - query: email automation
77. **manikantamadicharla103-art/Email_Automation_system** ★0 ``
   - 
   - https://github.com/manikantamadicharla103-art/Email_Automation_system
   - query: email automation
78. **SoulTreaure/ai-customer-service** ★0 `Python`
   - AI?????????? - ??RAG??????????????
   - https://github.com/SoulTreaure/ai-customer-service
   - query: ai customer service
79. **AliAhmedSheikh/AI-B2B-Lead-Generation-System** ★0 ``
   - 
   - https://github.com/AliAhmedSheikh/AI-B2B-Lead-Generation-System
   - query: lead generation
80. **YVATSAL/LinkedIn-Lead-Generator** ★0 ``
   ...
   - query: lead generation
81. **Meenakshitm2005/FUTURE_UX_01** ★0 ``
   ...
   - query: lead generation
82. **Brendin10/ChicagoRealEstateLeadGeneration** ★0 ``
   - 
   - https://github.com/Brendin10/ChicagoRealEstateLeadGeneration
   - query: lead generation
83. **HBarefoot/engram** ★4 `JavaScript`
   ...
   - query: ai agent
84. **Qwkapital/blackstack-public** ★0 ``
   ...
   - query: ai agent
85. **gbessoni/seobuild-onpage** ★216 `Python`
   ...
   - query: ai agent
86. **Whatsonyourmind/deckforge** ★3 `Python`
   ...
   - query: ai agent
87. **joshimohanlalit1303-ctrl/ContextOS** ★0 `TypeScript`
   ...
   - query: ai agent
88. **JiangLin1297/Agent-Organization-Management** ★1 `HTML`
...
96. **ahakimsheik7/tayo360-frontdesk-ai** ★0 ``
   ...
   - query: business automation
97. **systempromptio/systemprompt-template** ★14 `Rust`
...
99. **Roxabi/factory-site** ★0 ``
   ...
   - query: ai agent
100. **do-ops885/do-deal-relay** ★0 `TypeScript`
