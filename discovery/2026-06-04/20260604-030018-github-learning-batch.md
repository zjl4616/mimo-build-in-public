...
2. **Noumenon-ai/nexus-core** ★0 `Python`
   ...
   - query: mcp server
3. **snyk/agent-scan** ★2520 `Python`
   - Security scanner for AI agents, MCP servers and agent skills.
   - https://github.com/snyk/agent-scan
   - query: mcp server
4. **ErikThiart/simcloud-codex-plugin** ★0 ``
   ...
   - query: mcp server
5. **777Timo/nodebook-backend** ★0 `Swift`
   ...
   - query: mcp server
6. **rnd-pro/agent-pool-mcp** ★4 `JavaScript`
   ...
   - query: mcp server
7. **krishgokul92/UnrealAI-MCP** ★0 `C++`
   ...
   - query: mcp server
8. **marselsel/revolut-business-mcp** ★0 `TypeScript`
...
10. **malkreide/swiss_electricity_mcp** ★0 `Python`
   ...
   - query: mcp server
11. **m3252/ai-switch** ★0 `JavaScript`
   ...
   - query: mcp server
12. **bigirimanainnocent12/burundi_rag_chatbot** ★0 `Python`
   - 
   - https://github.com/bigirimanainnocent12/burundi_rag_chatbot
   - query: rag chatbot
13. **devinW19/ai-ticketing-system** ★0 ``
   ...
   - query: rag chatbot
14. **Arnab-Pachal1234/DocuMind** ★0 `Python`
   - This is a context aware rag chatbot
   - https://github.com/Arnab-Pachal1234/DocuMind
   - query: rag chatbot
15. **kssudeep/AI-Healthcare-Assistant-Platform** ★0 `Jupyter Notebook`
   ...
   - query: rag chatbot
16. **abhinavrdy18/Ollama-RAG-Assistant** ★0 `Python`
   ...
   - query: rag chatbot
17. **RAMAPRIYAM268/AI-POWERED-EMAIL-AUTOMATION-WORKFLOW** ★0 ``
...
18. **yusufberatbozkurt8/invoice-automation-service** ★0 ``
   - 
   - https://github.com/yusufberatbozkurt8/invoice-automation-service
   - query: invoice automation
19. **mastepanoski/claude-skills** ★37 `JavaScript`
...
25. **Asphane/YT-ChatBot-RAG** ★0 `Jupyter Notebook`
   ...
   - query: rag chatbot
26. **gmh5225/awesome-ai-security** ★21 ``
   ...
   - query: ai security
27. **madhucnghubphilips/AI-Security-Learning-Hub** ★0 ``
   ...
   - query: ai security
28. **emaina-SecEngr/AbuTech-ai-security-platform** ★0 `Python`
   ...
   - query: ai security
29. **YSR4038/Apex-Retail-Intelligence-Secure-Operations-AI-Security-Console** ★0 `TypeScript`
   ...
   - query: ai security
30. **Daryoush1989/ai-security-triage-platform** ★0 `Python`
   - 
   - https://github.com/Daryoush1989/ai-security-triage-platform
   - query: ai security
31. **zosob/AgentGuardian** ★0 `Python`
...
35. **Yashvi2912/AI-Cold-Email-Automation** ★0 ``
   ...
   - query: email automation
36. **Av1352/rag-chatbot-faiss** ★0 `Python`
   - 
   - https://github.com/Av1352/rag-chatbot-faiss
   - query: rag chatbot
37. **adya07pandey/CreatorLens** ★0 `Python`
   ...
   - query: rag chatbot
38. **Kanaieu/chatKUHP** ★0 `TypeScript`
   ...
   - query: rag chatbot
39. **I-am-Hanish/RAG-CHATBOT** ★0 `Python`
   - 
   - https://github.com/I-am-Hanish/RAG-CHATBOT
   - query: rag chatbot
40. **Meirah0/rag-ai-chatbot** ★0 ``
...
57. **erchandrain-ui/Email-Automation-Reminder-System** ★0 `HTML`
   ...
   - query: email automation
58. **Elavarasan-Saravanan/Open-Invoice-Automation** ★0 ``
   ...
   - query: invoice automation
59. **annai-stack/oangle-lead-finder** ★0 `Python`
...
61. **MadhuSudhan138/Email_NonStop** ★0 ``
   ...
   - query: email automation
62. **Vinphy6/outlook-email-automation** ★0 ``
   - 
   - https://github.com/Vinphy6/outlook-email-automation
   - query: email automation
63. **mansisonani07/immigration-lead-gen-system** ★0 ``
...
72. **ibmbpm/ibm-baw-mcp-server** ★9 `Python`
   ...
   - query: business automation
73. **Krishna17-bit/ContentFlow** ★0 ``
   ...
   - query: content automation
74. **yossweh/cold-email-engine** ★0 ``
   ...
   - query: email automation
75. **saeseduardo/ai-customer-service-platform** ★0 ``
...
76. **nirbhayalone27/Skynex** ★1 `JavaScript`
...
77. **sekharson/LaunchBoost** ★0 ``
   ...
   - query: lead generation
78. **sekharson/Launch-Boost** ★0 ``
   - LaunchBoost is a modern digital marketing services website for startups featuring responsive design, interactive service sliders, pricing plans, case studies, comparison tables, and lead-generation focused user experienc
   - https://github.com/sekharson/Launch-Boost
   - query: lead generation
79. **ambrose-kutti/ML-PaperStream** ★0 ``
   ...
   - query: zapier
80. **anujkd09/Zapier-deployment-events-api** ★0 ``
   ...
   - query: zapier
81. **exekyute/zapier-proj-health-rollup** ★0 ``
   ...
   - query: zapier
82. **hanschauhan464-art/AI-STUDENT-INTEREST-ANALYZER** ★0 ``
...
88. **tinkunagasaipavan/Content_Marketing** ★0 ``
   ...
   - query: lead generation
89. **kitretsu2809/YOUR_OWN_BUSINESS_CREW** ★0 ``
   - THE BUSINESS AUTOMATION 
   - https://github.com/kitretsu2809/YOUR_OWN_BUSINESS_CREW
   - query: business automation
90. **DDS-Solutions/AI-TadPole-OS** ★4 `TypeScript`
   ...
   - query: ai agent
91. **MemTensor/MemOS** ★9515 `TypeScript`
   - Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings
   - https://github.com/MemTensor/MemOS
   - query: ai agent
92. **everruns/sdk** ★0 `Python`
   ...
   - query: ai agent
93. **Austin-Muhe/UnknownMazeExplorer** ★0 `Python`
   ...
   - query: ai agent
94. **eranroseman/memoria-vault** ★1 `Python`
