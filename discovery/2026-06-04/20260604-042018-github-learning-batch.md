...
7. **Upload-Post/upload-post-mcp** ★1 `TypeScript`
   ...
   - query: mcp server
8. **sectum-ai/awesome-multi-tenant-ai-security** ★0 ``
   ...
   - query: ai security
9. **Hamza-ahmed0/RAG-chatbot** ★0 ``
   - 
   - https://github.com/Hamza-ahmed0/RAG-chatbot
   - query: rag chatbot
10. **laksh1441942-wq/RAG_chatbot** ★0 `Python`
   - 
   - https://github.com/laksh1441942-wq/RAG_chatbot
   - query: rag chatbot
11. **WickTech/autoflow** ★0 `Python`
...
13. **1999AZZAR/browser-agent-mcp** ★0 `JavaScript`
   ...
   - query: browser automation
14. **loa3026-hash/leoner-public-portfolio** ★0 `Python`
   ...
   - query: browser automation
15. **laravel/dusk** ★1940 `PHP`
   - Laravel Dusk provides simple end-to-end testing and browser automation.
   - https://github.com/laravel/dusk
   - query: browser automation
16. **Eyalm321/jlcpcb-mcp** ★1 `TypeScript`
   ...
   - query: mcp server
17. **DanielAvdar/dev-kit-mcp-server** ★6 `Python`
   - Agent development tool-kit
   - https://github.com/DanielAvdar/dev-kit-mcp-server
   - query: mcp server
18. **basilmentorcruise/caucus** ★0 `TypeScript`
   ...
   - query: mcp server
19. **felixgeelhaar/coverctl** ★0 `Go`
...
20. **peios/acta** ★0 `Go`
   ...
   - query: mcp server
21. **kingpanther13/Hubitat-local-MCP-server** ★10 `Groovy`
   - 
   - https://github.com/kingpanther13/Hubitat-local-MCP-server
   - query: mcp server
22. **teemow/mcp-midi-controller** ★0 `Go`
   ...
   - query: mcp server
23. **PrinceTitiya/AISCA-security-analyzer** ★0 ``
   - 
   - https://github.com/PrinceTitiya/AISCA-security-analyzer
   - query: ai security
24. **ahnaf240/sentinelshield** ★0 `JavaScript`
...
26. **UM-KevinHe/BRIER-MCP** ★0 `Python`
...
33. **timunbasah3/awesome-mcp** ★11 ``
   ...
   - query: mcp server
34. **adrex-ai/adrex-ai** ★0 `JavaScript`
   ...
   - query: mcp server
35. **rnd-pro/project-graph-mcp** ★3 `JavaScript`
...
39. **thaiphucc/NLP_LegalQA_public** ★0 `Python`
   ...
   - query: rag chatbot
40. **mr3ansar/Developershub-Task4-part2--RAG-Chatbot** ★0 ``
   ...
   - query: rag chatbot
41. **Kush0210/RAG-Document-Chatbot** ★1 `Python`
   ...
   - query: rag chatbot
42. **KhalidAhmed1/Mental-health-RAG** ★0 `Python`
   ...
   - query: rag chatbot
43. **AdityGITH/rag-chatbot-langchain** ★0 `Python`
...
54. **Het415/listinglens** ★1 `TypeScript`
   ...
   - query: rag chatbot
55. **tinyfish-io/agentql-integrations** ★27 `Jupyter Notebook`
...
57. **Noumenon-ai/nexus-core** ★0 `Python`
   ...
   - query: mcp server
58. **snyk/agent-scan** ★2520 `Python`
   - Security scanner for AI agents, MCP servers and agent skills.
   - https://github.com/snyk/agent-scan
   - query: mcp server
59. **ErikThiart/simcloud-codex-plugin** ★0 ``
   ...
   - query: mcp server
60. **777Timo/nodebook-backend** ★0 `Swift`
   ...
   - query: mcp server
61. **rnd-pro/agent-pool-mcp** ★4 `JavaScript`
   ...
   - query: mcp server
62. **krishgokul92/UnrealAI-MCP** ★0 `C++`
   ...
   - query: mcp server
63. **marselsel/revolut-business-mcp** ★0 `TypeScript`
...
65. **malkreide/swiss_electricity_mcp** ★0 `Python`
   ...
   - query: mcp server
66. **m3252/ai-switch** ★0 `JavaScript`
   ...
   - query: mcp server
67. **bigirimanainnocent12/burundi_rag_chatbot** ★0 `Python`
   - 
   - https://github.com/bigirimanainnocent12/burundi_rag_chatbot
   - query: rag chatbot
68. **devinW19/ai-ticketing-system** ★0 ``
   ...
   - query: rag chatbot
69. **Arnab-Pachal1234/DocuMind** ★0 `Python`
   - This is a context aware rag chatbot
   - https://github.com/Arnab-Pachal1234/DocuMind
   - query: rag chatbot
70. **kssudeep/AI-Healthcare-Assistant-Platform** ★0 `Jupyter Notebook`
   ...
   - query: rag chatbot
71. **abhinavrdy18/Ollama-RAG-Assistant** ★0 `Python`
   ...
   - query: rag chatbot
72. **RAMAPRIYAM268/AI-POWERED-EMAIL-AUTOMATION-WORKFLOW** ★0 ``
...
73. **yusufberatbozkurt8/invoice-automation-service** ★0 ``
   - 
   - https://github.com/yusufberatbozkurt8/invoice-automation-service
   - query: invoice automation
74. **mastepanoski/claude-skills** ★37 `JavaScript`
...
80. **Asphane/YT-ChatBot-RAG** ★0 `Jupyter Notebook`
   ...
   - query: rag chatbot
81. **gmh5225/awesome-ai-security** ★21 ``
   ...
   - query: ai security
82. **madhucnghubphilips/AI-Security-Learning-Hub** ★0 ``
   ...
   - query: ai security
83. **emaina-SecEngr/AbuTech-ai-security-platform** ★0 `Python`
   ...
   - query: ai security
84. **YSR4038/Apex-Retail-Intelligence-Secure-Operations-AI-Security-Console** ★0 `TypeScript`
   ...
   - query: ai security
85. **Daryoush1989/ai-security-triage-platform** ★0 `Python`
   - 
   - https://github.com/Daryoush1989/ai-security-triage-platform
   - query: ai security
86. **zosob/AgentGuardian** ★0 `Python`
...
90. **Yashvi2912/AI-Cold-Email-Automation** ★0 ``
   ...
   - query: email automation
91. **Av1352/rag-chatbot-faiss** ★0 `Python`
   - 
   - https://github.com/Av1352/rag-chatbot-faiss
   - query: rag chatbot
92. **adya07pandey/CreatorLens** ★0 `Python`
   ...
   - query: rag chatbot
93. **Kanaieu/chatKUHP** ★0 `TypeScript`
   ...
   - query: rag chatbot
94. **I-am-Hanish/RAG-CHATBOT** ★0 `Python`
   - 
   - https://github.com/I-am-Hanish/RAG-CHATBOT
   - query: rag chatbot
95. **Meirah0/rag-ai-chatbot** ★0 ``
